...
const skills = [
  {
    ...
    description: "Centralize customer data, automate workflows, and strengthen relationships with custom CRM solutions.",
    image: app1,
  },
  {
    title: "Custom Business Software",
    description: "Custom software designed to automate processes, boost efficiency, and solve business challenges.",
    image: app2,
  },
  {
    title: "LMS Development",
    description: "Build scalable learning platforms with user management, course tracking, and analytics.",
    image: app3,
  },
];
export default function AppSkillsSection() {
  return (
    <section className="bg-[#EDEDED] py-20 px-6 lg:px-16 overflow-hidden">
      {/* Heading */}
