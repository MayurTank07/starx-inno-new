  ...
  useEffect(() => {
    ...
    const typing = setInterval(() => {
      ...
      if (index > fullText.length) {
        ...
        setIsTypingDone(true); // stop cursor after typing
      }
    }, 40);
    ...
    <>
      ...
      <div className="max-w-xl">
            ...
            .map((part, i, arr) =>
              i === arr.length - 1 ? (
                ...
                <React.Fragment key={i}>
                  {part}
                  <span className="text-orange-500">MERN</span>
                </React.Fragment>
              )
            )}
        ...
        <p className="mt-6 text-gray-400 text-lg font-metropolis max-w-lg leading-relaxed">
          Master MERN and create high-performance web apps
