  ...
  return (
    <section className="bg-black text-white py-28 relative overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-monsterrat">
          The StarX{" "}
          <span className="text-orange-500">Success Framework</span>
        </h2>
        <p className="text-white/90 mt-5 text-lg max-w-2xl mx-auto px-6">
          A 7-step journey designed to turn learning into expertise and expertise into opportunity.
        </p>
      </div>

      {/* Mobile: simple grid, Desktop: timeline */}
      <div className="mt-16 px-6 grid grid-cols-1 sm:grid-cols-2 lg:hidden gap-6 max-w-4xl mx-auto">
        {steps.map((step, index) => (
          <div key={index} className={`p-6 rounded-2xl ${
            ...
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mb-4 text-white border border-orange-500">
              {index + 1}
            </div>
