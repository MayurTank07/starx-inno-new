...
export default function Home() {
  ...
  const title = "Students Who Turned Skills into Careers";
  const highlightWords = ["Students"];
  const subtitle = "MERN Stack Reviews";
  ...
  return (
    <div className="bg-[#F5F5F5] min-h-screen flex flex-col lg:flex-row items-center px-6 md:px-12 lg:px-24 gap-10 relative py-16">
      ...
      <div className="max-w-xl">
        ...
        {/* Buttons (kept same UI, no functionality) */}
