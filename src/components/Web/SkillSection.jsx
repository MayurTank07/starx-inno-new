...
import R1 from "../../assets/images/web/R1.png";
import R2 from "../../assets/images/web/R2.png";
import R3 from "../../assets/images/web/R3.png";
...
export default function SkillsSection() {
  return (
    <section className="bg-gray-100 py-20 px-6 lg:px-24 overflow-hidden">
